...
import com.benpetroski.framework.Image;
...
public class GameScreen extends Screen {
	...
	public void paint(float deltaTime) {
		...
		g.drawImage(hanim.getImage(), hb2.getCenterX()-61, hb2.getCenterY()-48);
	...
	private void drawReadyUI() {
		...
		g.drawString("Tap each side of the screen to move in that direction.", 400, 240, paint);
	}
