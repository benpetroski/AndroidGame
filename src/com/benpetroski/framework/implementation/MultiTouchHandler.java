...
import com.benpetroski.framework.Input;
import com.benpetroski.framework.Input.TouchEvent;
import com.benpetroski.framework.Pool;
import com.benpetroski.framework.Pool.PoolObjectFactory;
		...
		synchronized (this) {
			...
			for (int i=0; i<MAX_TOUCHPOINTS; i++) {
				...
				if (event.getAction() != MotionEvent.ACTION_MOVE && i != pointerIndex) {
					// if up/down/cancel/out event, mask the id to see if touch should be handled
					continue;
				}
				switch(action){
